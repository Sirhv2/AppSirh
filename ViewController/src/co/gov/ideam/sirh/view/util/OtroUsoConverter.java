...
public class OtroUsoConverter implements Converter, Serializable {
     /**Almacena la lista de resultados.*/
      ...
      public List<Lista> getValores() throws Exception {
          if (this.listaResult == null) {
              ...
              this.listaResult = pd.getAllListaByCategoria(ConstantesParametros.CATEGORIA_OTROS_USOS_AGUA);
          }
