...
public class TipoFuenteCaptacionConverter implements Converter, Serializable {
     /**Almacena la lista de subzonas.*/
      ...
      public List<Lista> getValores() throws Exception {
          if (this.listaResult == null) {
              ...
              this.listaResult = pd.getAllListaByCategoria(ConstantesParametros.CATEGORIA_TIPO_FUENTE_CAPTA);
          }
