...
public class CaudalTipoUsuarioBacking extends CaudalTipoUsuario{
    ...
    private RichInputDate idFini;
    private RichInputDate idFFin;
    ...
    public CaudalTipoUsuarioBacking() {
        FacesUtils.setActiveBean("caudalTipoUsuarioBean", "Caudal por Tipo",
    ...
    public void cmdBuscar_actionListener(ActionEvent actionEvent) {
        try{
            ...
            if(this.idFini.getValue()==null){
                showMessage("obligatorio",FacesMessage.SEVERITY_ERROR,this.idFini);       
                return;
            }
            
            if(this.idFFin.getValue()==null){
                showMessage("obligatorio",FacesMessage.SEVERITY_ERROR,this.idFFin);       
                return;
            }
            
            
            Date fechaInicio = new Date();
            fechaInicio = ((this.idFini.getValue()!=null)
                    ?(Date)this.idFini.getValue()
                    :null);
            
            Date fechaFin = new Date();
            fechaFin = ((this.idFFin.getValue()!=null)
                    ?(Date)this.idFFin.getValue()
                    :null);
    ...
    public void setIdFini(RichInputDate inputDate1) {
        this.idFini = inputDate1;
    }

    public RichInputDate getIdFini() {
        return idFini;
    }

    public void setIdFFin(RichInputDate inputDate2) {
        this.idFFin = inputDate2;
    }

    public RichInputDate getIdFFin() {
        return idFFin;
    }
