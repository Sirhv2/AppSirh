...
public class ObservatorioDemandaBaking extends StandarDashBoard{
  ...
  */
    ...
    public ObservatorioDemandaBaking() {      
        FacesUtils.setActiveBean("observatorioDemandaBacking", "ObservatorioDemandaBaking",
