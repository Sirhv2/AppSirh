...
public class ObservatorioBacking extends StandarDashBoard{
    ...
    public ObservatorioBacking() {
        FacesUtils.setActiveBean("observatorioBacking", "ObservatorioBacking",
                                 ObservatorioBacking.class);
