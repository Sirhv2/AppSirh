...
public class ObservatorioMainBacking extends StandarDashBoard{
    ...
    public ObservatorioMainBacking() {
        FacesUtils.setActiveBean("observatorioMainBacking", "ObservatorioMainBacking",
                                 ObservatorioMainBacking.class);
