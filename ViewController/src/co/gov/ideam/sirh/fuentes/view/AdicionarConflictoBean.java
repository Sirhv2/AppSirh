...
public class AdicionarConflictoBean extends StandarBean {
    ...
    public AdicionarConflictoBean() {
        FacesUtils.setActiveBean("adicionarConflictoBean",
                                 "Adicionar Conflicto",
                                 AdicionarConflictoBean.class);
    ...
    public void load() {
        try {
            ...
            conflicto.setLatitudSegundos(new BigDecimal("0"));
            conflicto.setLongitudSegundos(new BigDecimal("0"));
            conflicto.setAltitud(new BigDecimal("0"));
    ...
    public void cb_aceptar_actionListener(ActionEvent actionEvent) {
        accionAdicionar = "editarConflicto";
