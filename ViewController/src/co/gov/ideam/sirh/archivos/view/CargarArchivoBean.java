...
public class CargarArchivoBean extends StandarBean{
    private RichForm f2;
    ...
    public CargarArchivoBean(){
        FacesUtils.setActiveBean("cargarArchivo",
                                 "Usuarios Del Agua",
    ...
    public void cb_cargar_data_actionListener(ActionEvent actionEvent) {
        System.out.println("---->Carga Excel para registrar datos");
        ...
        if(this.listaDatos!=null){
            ...
            System.out.println("---->pasa por registros validos");
        }
        if(!valido){
        ...
        try{
            ...
            while(it.hasNext()){
                ...
                if (converter instanceof
                    ...
                    System.out.println("---->registrarUsuarioAguaCaptacionesNatural");
                    this.registrosCargados += LoadDataUtil.registrarUsuarioAguaCaptacionesNatural(converter, fila,
                                                                                                  usuarioConectado.getUsuario().getAutoridadAmbiental());
                } else if (converter instanceof
                           UsuariosAguaCaptacionesJuridicaConverter) {
                    System.out.println("---->registrarUsuarioAguaCaptacionesJuridica");
                    this.registrosCargados += LoadDataUtil.registrarUsuarioAguaCaptacionesJuridica(converter, fila,
                                                                                                   usuarioConectado.getUsuario().getAutoridadAmbiental());
                } else if (converter instanceof
                           UsuariosAguaPermisosNaturalConverter) {
                    System.out.println("---->registrarUsuarioAguaPermisosNatural");
                    this.registrosCargados += LoadDataUtil.registrarUsuarioAguaPermisosNatural(converter, fila,
                                                                                               usuarioConectado.getUsuario().getAutoridadAmbiental());
                } else if (converter instanceof
                           UsuariosAguaPermisosJuridicaConverter) {
                    System.out.println("---->registrarUsuarioAguaPermisosJuridica");
                    this.registrosCargados += LoadDataUtil.registrarUsuarioAguaPermisosJuridica(converter, fila,
                                                                                                usuarioConectado.getUsuario().getAutoridadAmbiental());
                } else if (converter instanceof FuentesConverter) {
                    System.out.println("---->registrarFuente");
                    this.registrosCargados += LoadDataUtil.registrarFuente(converter, fila,
                                                                           usuarioConectado.getUsuario().getAutoridadAmbiental());
                } else if (converter instanceof PuntosMonitoreoConverter) {
                    System.out.println("---->registrarPuntosMonitoreo");
                    this.registrosCargados += LoadDataUtil.registrarPuntosMonitoreo(converter, fila,
                                                                                    usuarioConectado.getUsuario().getAutoridadAmbiental());
                } else if (converter instanceof MuestrasMedicionesConverter) {
                    System.out.println("---->registrarMediciones");
                    this.registrosCargados += LoadDataUtil.registrarMediciones(converter, fila,
                                                                               usuarioConectado.getUsuario().getAutoridadAmbiental());
                } else if (converter instanceof
                           UsuariosAguaCaptacionesServiciosConverter) {
                    System.out.println("---->registrarUsuarioAguaCaptacionesServicios");
                    this.registrosCargados += LoadDataUtil.registrarUsuarioAguaCaptacionesServicios(converter, fila,
                                                                                                    usuarioConectado.getUsuario().getAutoridadAmbiental());
                } else if (converter instanceof
                           UsuariosAguaPermisosServiciosConverter) {
                    System.out.println("---->registrarUsuarioAguaPermisosServicios");
                    this.registrosCargados += LoadDataUtil.registrarUsuarioAguaPermisosServicios(converter, fila,
                                                                                                 usuarioConectado.getUsuario().getAutoridadAmbiental());
                } else if (converter instanceof FuniasGeologiaConverter) {
                    this.registrosCargados += LoadDataUtil.registrarFuniasGeologia(converter, fila,
                                                                                   usuarioConectado.getUsuario().getAutoridadAmbiental());
                } else if (converter instanceof
                    ...
                    this.registrosCargados += LoadDataUtil.registrarFuniasConstruccion(converter, fila,
                                                                                       usuarioConectado.getUsuario().getAutoridadAmbiental());
                } else if (converter instanceof
                    ...
                    this.registrosCargados += LoadDataUtil.registrarFuniasGeofisica(converter, fila,
                                                                                    usuarioConectado.getUsuario().getAutoridadAmbiental());
                } else if (converter instanceof FuniasDiagnosticoConverter) {
                    this.registrosCargados += LoadDataUtil.registrarFuniasDiagnostico(converter, fila,
                                                                                      usuarioConectado.getUsuario().getAutoridadAmbiental());
                } else if (converter instanceof
