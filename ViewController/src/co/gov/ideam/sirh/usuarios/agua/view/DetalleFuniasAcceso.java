...
public class DetalleFuniasAcceso extends StandarBean{
    ...
    private RichInputText itAcceso;

    public DetalleFuniasAcceso(){
        FacesUtils.setActiveBean("detalleFuniasAcceso",
                                 "Detalle de Funias", 
    ...
    public void ifDocumento_valueChangeListener(ValueChangeEvent valueChangeEvent) {
        System.out.println("================================FUNIAS ACCESO FILE NEW: ");
        ...
        System.out.println("================================FUNIAS ACCESO FILE NEW: "+fileNew);
        if (fileNew!=null){
            ...
            this.cargarArchivo(fileNew, fileOld, ConstantesCaptaciones.ARCHIVO_TIPO_CROQUIS);
    ...
    public void cbAceptar_actionListener(ActionEvent actionEvent) {
        ...
        if(this.itAcceso.getValue()==null){
    ...
    public void save(){
        try{
            ...
            this.funias.setAcceso((this.itAcceso.getValue()!=null)
                               ?this.itAcceso.getValue().toString()
                               :null);
            ...
            if(this.funias.getId()!=null && this.funias.getId()>0){
                ...
                this.funias.setTipoFunias(ConstantesParametros.LISTA_ACCESO.intValue());
    ...
    public void setItAcceso(RichInputText inputText1) {
        this.itAcceso = inputText1;
    }

    public RichInputText getItAcceso() {
        return itAcceso;
    }
}
