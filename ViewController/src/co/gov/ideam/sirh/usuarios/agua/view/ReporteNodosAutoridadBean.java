...
public class ReporteNodosAutoridadBean extends StandarBean{
    private RichForm f2;
    private RichDocument d2;
    private RichPanelCollection pc1;
    private List listaReporteNodosAutoridad;    
    ...
    private RichTable t_reporteNodosAutoridad;
    ...
    public ReporteNodosAutoridadBean(){
        FacesUtils.setActiveBean("ReporteNodosAutoridadBean",
                                 "ReporteNodosAutoridadBean",
    ...
    public void load(){
        try{            
            ...
            if (usuarioConectado.getUsuario().getAutoridadAmbiental()==null ||
                ...
                this.listaReporteNodosAutoridad= new ArrayList();
                listaUsuarioLogin= new ArrayList();
                this.visiblePerfil="false";
                this.listaAutoridades= this.cargarAutoridadesNodos();
             
            }else{
                this.visiblePerfil="true";
                 listaReporteNodosAutoridad = uad.getReporteNodos(null);                  
    ...
    public void buscar() throws IdeamException {
        ...
        try{            
            UsuarioConectadoTO usuarioConectado = 
                (UsuarioConectadoTO)FacesUtils.getFromSession("usuarioConectado");
            listaReporteNodosAutoridad = new ArrayList();
            UsuariosAguaDelegate uad = UsuariosAguaDelegate.getInstance();
            SeguridadDelegate seg = SeguridadDelegate.getInstance(); 
            ...
            if (usuarioConectado.getUsuario().getAutoridadAmbiental()==null ||
                ...
                usuarioConectado.getUsuario().getAutoridadAmbiental().getId().longValue() == Constantes.IDEAM ||
                pp.getCodigo()==ConstantesCalidad.PERFIL_CONSULTA){
                    listaReporteNodosAutoridad =uad.getReporteNodos(
                                       this.autoridadRolRevision );
            }
                
            AdfFacesContext.getCurrentInstance().addPartialTarget(t_reporteNodosAutoridad);
    ...
    public void cmi_imprimir_actionListener(ActionEvent actionEvent) {
        try {
            ...
            parametros.put("p_titulo","Reporte de Datos Nodos");                        
            this.generateReport("ReporteNodos.jasper",                                                                 
                                this.listaReporteNodosAutoridad,
                                parametros,
    ...
    public void setT_reporteNodosAutoridad(RichTable t_reporteNodosAutoridad) {
        this.t_reporteNodosAutoridad = t_reporteNodosAutoridad;
    }

    public RichTable getT_reporteNodosAutoridad() {
        return t_reporteNodosAutoridad;
    }

    public void setListaReporteNodosAutoridad(List listaReporteNodosAutoridad) {
        this.listaReporteNodosAutoridad = listaReporteNodosAutoridad;
    }

    public List getListaReporteNodosAutoridad() {
        return listaReporteNodosAutoridad;
    }
