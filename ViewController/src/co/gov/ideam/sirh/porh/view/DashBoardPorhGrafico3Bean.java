...
public class DashBoardPorhGrafico3Bean extends StandarDashBoard {
  ...
  public DashBoardPorhGrafico3Bean() {
    FacesUtils.setActiveBean("DashBoardPorhGrafico3Bean",
                             "DashBoardPorhGrafico3Bean",
