...
public class DashBoardPorhGrafico4Bean extends StandarDashBoard {
  ...
  public DashBoardPorhGrafico4Bean() {
    FacesUtils.setActiveBean("DashBoardPorhGrafico4Bean",
                             "DashBoardPorhGrafico4Bean",
