...
public class ListarProyectosBean extends StandarBean {
    ...
    public String cl_todasFuentes_action() {
        FacesUtils.removeManagedBeanFromSession("ListarProyectosBean");
    ...
    public String cm_editar_action() {
        ...
        FacesUtils.removeFromSession("proyectoSeleccionado");
        FacesUtils.setInSession("proyectoSeleccionado", proyectoSeleccionado);
    ...
    public String cm_borrar_action() {
        ...
        String params[] = { proyectoSeleccionado.getNombre() };
        String texto = getText("MENSAJE_BORRAR_PROYECTO", params);
    ...
    public void t_actividades_selectionListener(SelectionEvent selectionEvent) {
        try {
            ...
            this.proyectoSeleccionado = (Proyecto)t_act.getSelectedRowData();
    ...
    public String cb_si_borrar_action() {
        try {
            ...
            proyectoSeleccionado.setCodigoAutoridad(autoridadAmbiental.getId().longValue());

            PomcaDelegate pd = PomcaDelegate.getInstance();
            pd.deleteProyecto(proyectoSeleccionado);
            ...
            showMessage(getText("MENSAJE_BORRAR_PROYECTO_EXITOSO"),FacesMessage.SEVERITY_INFO);       
    ...
    public ListarProyectosBean() {

        FacesUtils.setActiveBean("ListarProyectosBean", "Listar PROYECTOS",
                                 PomcaDelegate.class);
        load();
    ...
    private void load() {
        ...
        try {
            ...
            listaProyectos = pd.getProyectos(programa);
