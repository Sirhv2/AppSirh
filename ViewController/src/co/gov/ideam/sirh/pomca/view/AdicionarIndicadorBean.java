...
public class AdicionarIndicadorBean {
    ...
    public void setIt_nombre_actividad(RichInputText it_nombre) {
        this.it_nombre_actividad = it_nombre;
    }
    ...
    public AdicionarIndicadorBean() {
        FacesUtils.setActiveBean("AdicionarIndicadorBean", "Adicionar Indicador",
                                 PomcaDelegate.class);
        load();
    ...
    private void load() {
        try {
            ...
            indicador.setNombre("");
            indicador.setPorcCumplimiento(0D);
            indicador.setMeta(0);
    ...
    public void guardarIndicador() {
        try {
            ...
            pd.addIndicador(indicador);
            showPopup(p_registro_exitoso, true);

            FacesUtils.removeManagedBeanFromSession("AdicionarIndicadorBean");
