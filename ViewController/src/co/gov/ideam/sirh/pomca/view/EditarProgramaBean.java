...
public class EditarProgramaBean {
    ...
    private RichCommandButton cb_update;
    ...
    public EditarProgramaBean() {
        FacesUtils.setActiveBean("EditarProgramaBean", "Editar Programa",
                                 PomcaDelegate.class);
        load();
    ...
    public void setCb_update(RichCommandButton commandButton1) {
        this.cb_update = commandButton1;
    }

    public RichCommandButton getCb_update() {
        return cb_update;
    }

    public void cb_update_action() {
        // Add event code here...
        try{
            ...
            PomcaDelegate pd = PomcaDelegate.getInstance();
            pd.updatePrograma(programa);
            showPopup(p_registro_exitoso, true);
            
            FacesUtils.removeManagedBeanFromSession("EditarProgramaBean");
