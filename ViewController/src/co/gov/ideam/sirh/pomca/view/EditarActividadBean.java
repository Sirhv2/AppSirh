...
public class EditarActividadBean {
    ...
    private RichInputText it_nombreProyecto;
    ...
    private RichCommandButton cbAdicionar;
    ...
    public void setIt_nombrePrograma(RichInputText it_nombre) {
        this.it_nombrePrograma = it_nombre;
    }
    ...
    public void setIt_nombreProyecto(RichInputText inputText1) {
        this.it_nombreProyecto = inputText1;
    }

    public RichInputText getIt_nombreProyecto() {
        return it_nombreProyecto;
    }
    ...
    public void setCbAdicionar(RichCommandButton cbNext1) {
        this.cbAdicionar = cbNext1;
    }

    public RichCommandButton getCbAdicionar() {
        return cbAdicionar;
    }
    ...
    public EditarActividadBean() {
        FacesUtils.setActiveBean("EditarActividadBean", "Editar Actividad",
                                 PomcaDelegate.class);
        load();
    ...
    public String cbAdicionar_action() {

        if (this.it_nombrePrograma.getValue() == null) {
            showMessage("obligatorio", FacesMessage.SEVERITY_ERROR,
                        this.it_nombrePrograma);
            return "";
        }

        if (this.it_nombrePrograma.getValue().toString().length() == 0) {
            showMessage("obligatorio", FacesMessage.SEVERITY_ERROR,
                        this.it_nombrePrograma);
            return "";
        }
    ...
    public void guardarActividad() {
        try {
            ...
            programa.setNombre(it_nombrePrograma.getValue().toString().toUpperCase());
            PomcaDelegate pd = PomcaDelegate.getInstance();

            pd.updateActividad(actividad);
            showPopup(p_registro_exitoso, true);

            FacesUtils.removeManagedBeanFromSession("EditarActividadBean");
