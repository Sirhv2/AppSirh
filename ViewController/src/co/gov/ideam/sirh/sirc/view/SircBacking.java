package co.gov.ideam.sirh.sirc.view;
...
public class SircBacking extends StandarDashBoard{
    ...
    public SircBacking() {
        FacesUtils.setActiveBean("sircBacking", "SircBacking",
                                 SircBacking.class);
        FacesUtils.removeFromSession("OrigenNavegacionUsuario");
        FacesUtils.setInSession("OrigenNavegacionUsuario","sirc");
    }
