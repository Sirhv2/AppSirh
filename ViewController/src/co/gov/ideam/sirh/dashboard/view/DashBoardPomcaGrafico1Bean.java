...
public class DashBoardPomcaGrafico1Bean extends StandarDashBoard{

    static Logger logger = Logger.getLogger(DashBoardPomcaGrafico1Bean.class);
    ...
    public DashBoardPomcaGrafico1Bean(){
        FacesUtils.setActiveBean("dashBoardPomcaGrafico1Bean",
                                 "DashBoardPomcaGrafico1Bean", DashBoardPomcaGrafico1Bean.class); 
        ...
        try {
            ...
            if (listaProgramas != null) {
                ...
                while (it.hasNext()) {
                    ...
                    logger.info("Dato :" + programa.getPorcEjecucion());
                    
                    seriesLabels[i] = programa.getNombre();
                    data2[0][i] = new Double(programa.getPorcEjecucion());
