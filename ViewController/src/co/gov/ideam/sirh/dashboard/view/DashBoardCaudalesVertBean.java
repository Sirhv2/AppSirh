...
public class DashBoardCaudalesVertBean  extends StandarDashBoard{
    ...
    public DashBoardCaudalesVertBean(){
        FacesUtils.removeManagedBeanFromSession("dashBoard");
        
        FacesUtils.setActiveBean("dashBoardCaudalesVert", "DashBoardCaudalesVertBean",
                                 DashBoardCaudalesVertBean.class);
       this.load();        
    }
