...
public class DashBoardConcesionesAnioBean  extends StandarDashBoard{
    ...
    private UIGraph barGraphConcesionesAnio;
    ...
    public DashBoardConcesionesAnioBean(){
        FacesUtils.setActiveBean("dashBoardConcesionesAnio",
                                 "DashBoardConcesionesAnioBean", DashBoardConcesionesAnioBean.class);
    ...
    public void load(){
            ...
            if(usuarioConectado==null){
                ...
                this.listaAnios = this.getListaAnioConcesiones(null);
                } else {   
              ...
              this.listaAnios = this.getListaAnioConcesiones(usuarioConectado.getUsuario().
    ...
    public void graficar( String anio){
            ...
            try{
                UsuariosAguaDelegate usus = UsuariosAguaDelegate.getInstance();
                if(anio.indexOf(".")!=-1){
                ...
                if(usuarioConectado==null){
                    datos = usus.getConcesionesAnio( aniofecha, null);
                 ...
                 datos= usus.getConcesionesAnio( aniofecha,usuarioConectado.getUsuario().
                                                           getAutoridadAmbiental().
                                                           getId().
                                                           longValue());
                    }  } 
                ...
                initGraphDataModel();
                AdfFacesContext.getCurrentInstance().addPartialTarget(this.barGraphConcesionesAnio);   
    ...
    public void setBarGraphConcesionesAnio(UIGraph barGraphConcesionesAnio) {
        this.barGraphConcesionesAnio = barGraphConcesionesAnio;
    }

    public UIGraph getBarGraphConcesionesAnio() {
        return barGraphConcesionesAnio;
    }
