...
public class DashBoardDemandaSubtProvinciaBean extends StandarDashBoard {
  ...
  public DashBoardDemandaSubtProvinciaBean() throws IdeamException {
    listaDatosGraf = new ArrayList<Object[]>();
    reportesDelegate = JSReportesDelegate.getInstance();
    System.out.println(">>Estoy en el DashBoardDemandaSubtProvinciaBean -> " + reportesDelegate);
    this.listaComponente = reportesDelegate.getComponenteDemandaXProvincia();
  ...
  public void salidaExcel_actionListener(ActionEvent actionEvent) {
          ...
          try {
            System.out.println("LLega al metodo salida excel 1 ");
              ...
              parametros.put("p_modulo", "Demanda X Provincia");
              parametros.put("p_titulo", "Demanda X Provincia");
              this.generateReport("ListadoProvincia.jasper", this.listaComponente,
