...
public class BusqFuentesZonifBean extends StandarBean {
    ...
    public void load() {
        ...
        try {
            Object obj = FacesUtils.getFromSession("tipoBusqueda");
            Integer tb=0;
              if(obj instanceof Integer){
                    tb = (Integer)obj;
                     
                     System.out.println("llega  ---------------"+ tb);
                   
              } 
            
            
            if(tb==1){//zonificacion
                
            System.out.println("area--------entro zonificacion------------");
                    this.selectOneChoice1.setVisible(true);
                    this.selectOneChoice2.setVisible(true);
                    this.selectOneChoice3.setVisible(true);
                    
            
                    this.selectOneChoice1.setRendered(true);
                    this.selectOneChoice2.setRendered(true);
                    this.selectOneChoice3.setRendered(true);
                     
                    this.selectAutoridad.setRendered(false);
                    ...
                    this.selectAutoridad.setVisible(false);
                ...
                System.out.println("area--------entro nombre------------");
                    ...
                    this.it_fuente.setRendered(true);
                ...
                } else if(tb==3){//Autoridad
                
                System.out.println("area--------entro autorid------------");
            ...
            else if(tb==4){ //Caudal concesionado
            System.out.println("area--------entro concesionado------------");
                                this.itCaudalCap.setRendered(true);
                                this.itCaudalCap.setVisible(true);
                                this.selectSigno.setVisible(true);
                                this.selectSigno.setRendered(true);
            ...
            else if(tb==5){//Caudal vertido
                
                                System.out.println("area--------entro vertido------------");
                                
                                this.itCaudalVert.setRendered(true);
                                this.itCaudalVert.setVisible(true);
                                this.selectSigno.setVisible(true);
                                this.selectSigno.setRendered(true);
    ...
    public void selectOneChoice1_valueChangeListener(ValueChangeEvent event) throws IdeamException {
        ...
        try {
            if (area != null) {
                this.listaZona = new ArrayList();
                this.listaZona =
                        this.cargarZonificacionExt(((PartZonificListas)area).getId(),Constantes.IDEAM);
            }
        } catch (IdeamException e) {
            showMessage(e);
        }
    ...
    public void selectOneChoice2_valueChangeListener(ValueChangeEvent event) throws IdeamException {
        ...
        try {
            if (zona != null) {
                this.listaSubzona = new ArrayList();
                this.listaSubzona =
                        this.cargarZonificacionExt(((PartZonificListas)zona).getId(),Constantes.IDEAM);
            }
        } catch (IdeamException e) {
            showMessage(e);
        }
    ...
    public void commandButton1_actionListener(ActionEvent actionEvent) throws IdeamException {
        ...
        if (this.itCaudalCap.getValue() != null && this.selectSigno.getValue() != null) {
        ...
        if (this.itCaudalVert.getValue() != null && this.selectSigno.getValue() != null) {
        ...
        try {
            ...
            if (i == 0) { //solo presionó el botón buscar
                ...
                this.listaFuentes =
                       uad.getListaFuentesExternas(criterios); //todas las fuentes
    ...
    public void cmiImprimir_actionListener(ActionEvent actionEvent) {
        ...
        ConsultasExtFuentesTO fuente = (ConsultasExtFuentesTO)t_fuentes.getSelectedRowData();
        try {
            ...
            this.generateReport("DetalleFuente.jasper",                                                                 
                                parametros,
                                ReporteDelegate.PDF);
        } catch (IdeamException e) {
            showMessage(e);
    ...
    public void t_fuentes_selectionListener(SelectionEvent selectionEvent) {
        ...
        this.fuenteSeleccionada = (ConsultasExtFuentesTO)t_fuentes1.getSelectedRowData();
