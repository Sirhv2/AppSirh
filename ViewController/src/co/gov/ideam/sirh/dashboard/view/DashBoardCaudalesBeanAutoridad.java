...
public class DashBoardCaudalesBeanAutoridad  extends StandarDashBoard{
    ...
    public DashBoardCaudalesBeanAutoridad(){
        FacesUtils.removeManagedBeanFromSession("dashBoard");
        
        FacesUtils.setActiveBean("dashBoardCaudales", "DashBoardCaudalesBeanAutoridad",
                                 DashBoardCaudalesBeanAutoridad.class);
       this.load();        
    }
        ...
        try{    
            ...
            UsuarioConectadoTO usuarioConectado = 
                ...
                if(usuarioConectado==null){
                    ...
                    this.listaCaudalesDetalle= uad.getListaCaudalesConcesionadosDetalle(null, codigo, codigoTramo);
                    } else {   
                   ...
                   this.listaCaudalesDetalle= uad.getListaCaudalesConcesionadosDetalle(usuarioConectado.getUsuario().
                                                   getAutoridadAmbiental().
                                                   getId().
