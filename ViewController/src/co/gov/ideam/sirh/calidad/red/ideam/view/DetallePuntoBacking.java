...
public class DetallePuntoBacking extends DetallePunto{
    ...
    public DetallePuntoBacking() {
        FacesUtils.setActiveBean("detallePuntoBean", "Punto Monitoreo Ideam",
                                 RedMonitoreoDelegate.class);
        
        FacesUtils.removeManagedBeanFromSession("MuestrasIdeamTreeHandler");
        FacesUtils.removeManagedBeanFromSession("muestrasBean");
        //FacesUtils.removeManagedBeanFromSession("detalleMuestraBean");
        this.load();
    }
    ...
    public void load() {
        try {
            ...
            nodoMuestras.setData("MuestrasIdeam");

            listaNodos.add(nodoMuestras); //adiciona el grupo

            if (this.muestrasList != null && !this.muestrasList.isEmpty()) {
                Iterator it = this.muestrasList.iterator();
                while (it.hasNext()) {
                    FqMuestras muestra = (FqMuestras)it.next();
                    Date fecham = muestra.getFechaMuestreo();
                    ...
                    TreeNode nodoMuestra =
                        new TreeNode("Muestra " + fechamuestra , "muestra",
                                     true, false);
