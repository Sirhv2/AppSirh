...
public class AdicionarPuntosMonitoreoVertBean extends StandarBean{
  ...
  private RichPanelGroupLayout panelGroupLayout8;
    ...
    public AdicionarPuntosMonitoreoVertBean(){
       FacesUtils.setActiveBean("adicionarPuntosMonitoreoVert",
                                "AdicionarPuntosdeMonitoreoVert",
  ...
  public void load(){
      ...
      try{      
       ...
       t_descripcion   =new RichInputText() ; 
        ...
        this.listaUbicacion = this.getListaPorCategoria(ConstantesCalidad.UBICACION_PUNTO_MONITOREO_VERT);
          ...
          this.vertimiento = new PuntoVertimiento();
          
          if(obj instanceof PuntoVertimiento){
              this.vertimiento = (PuntoVertimiento)obj;
              Long codigo =this.vertimiento.getId() ;                                           
         ...
         nro=listaPuntosMonitoreo.size();
          ...
          if(this.vertimiento.getId()!=null){
             this.llenaDatos(this.vertimiento, nro);
  ...
  public void llenaDatos(PuntoVertimiento vertimiento,Integer nro){
      
          try{     
              
              CalidadDelegate cald = CalidadDelegate.getInstance();
               
            if(vertimiento.getId()!=null){
                
                if(nro==null || nro==0){
                
                   nro=1; 
                   int idubi = Integer.parseInt(ConstantesCalidad.UBICACION_PUNTO_MONITOREO_VERT_FUENTE.toString());
              ...
              if(this.vertimiento.getIdDepartamento()!=null){
                  this.puntoMonitoreo.setIdDepartamento(this.vertimiento.getIdDepartamento().longValue());
                  this.vertimiento.setObjDepartamento(pd.getDivipolaById(this.vertimiento.getIdDepartamento().longValue()));
                  this.puntoMonitoreo.setDepartamento(this.vertimiento.getObjDepartamento());
              }
              if(this.vertimiento.getIdMunicipio()!=null){
                  this.puntoMonitoreo.setIdmunicipio(this.vertimiento.getIdMunicipio().longValue());
                  this.vertimiento.setObjMunicipio(pd.getDivipolaById(this.vertimiento.getIdMunicipio().longValue()));
                  this.puntoMonitoreo.setMunicipio(this.vertimiento.getObjMunicipio());
              }
             
              
                
                this.puntoMonitoreo.setIdFuente(this.vertimiento.getIdFuente());
                this.puntoMonitoreo.setIdTramo(this.vertimiento.getIdTramo());
                this.puntoMonitoreo.setIdArea(this.vertimiento.getIdTramo().getIdArea());
                this.puntoMonitoreo.setIdZona(this.vertimiento.getIdTramo().getIdZona());
                this.puntoMonitoreo.setIdSubzona(this.vertimiento.getIdTramo().getIdSubzona());
  ...
  public void save(){
           ...
           try{
              ...
              UsuarioConectadoTO usuarioConectado = (UsuarioConectadoTO)FacesUtils.getFromSession("usuarioConectado");
               ...
               this.puntoMonitoreo.setIdZona(this.vertimiento.getIdTramo().getIdZona());
               this.puntoMonitoreo.setIdSubzona(this.vertimiento.getIdTramo().getIdSubzona());
               puntoMonitoreo.setIdSist_ref(this.vertimiento.getSistemaReferencia());
               puntoMonitoreo.setCodigoAutoridad(usuarioConectado.getUsuario().getAutoridadAmbiental().getId().longValue());
               puntoMonitoreo.setIdVertimiento(this.vertimiento);
             ...
             PuntoMonitoreo pp=   cld.updatePuntoMonitoreo(this.puntoMonitoreo);
               ...
               try{
                   ...
                   auditoria.setObjeto("PUNT0S_MONITOREO_VERTIMIENTO");
