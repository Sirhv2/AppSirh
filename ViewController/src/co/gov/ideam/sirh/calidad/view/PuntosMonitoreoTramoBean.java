...
public class PuntosMonitoreoTramoBean  extends StandarBean{
  ...
  private FnttTramo tramo;
    ...
    private RichCommandLink clinkfuentes;
    private RichCommandLink clinkFuente;
    private RichCommandLink clinkTramo;
    private RichSpacer spacer2;
    private RichSpacer spacer3;
    private RichSpacer spacer4;

    public PuntosMonitoreoTramoBean(){
       FacesUtils.setActiveBean("puntosMonitoreoTramo",
                                "puntosMonitoreoTramo",
  ...
  public void cb_filtrar_actionListener(ActionEvent actionEvent) {
    ...
    if(this.filtro_nombre.getValue()!=null &&
      ...
      try{
          ...
          this.listaPuntosMonitoreo = cald.getPuntosMonitoreoTramo(criterios, this.tramo.getId());
    ...
    public void setClinkfuentes(RichCommandLink clinkfuentes) {
        this.clinkfuentes = clinkfuentes;
    }

    public RichCommandLink getClinkfuentes() {
        return clinkfuentes;
    }

    public void setClinkFuente(RichCommandLink clinkFuente) {
        this.clinkFuente = clinkFuente;
    }

    public RichCommandLink getClinkFuente() {
        return clinkFuente;
    }

    public void setClinkTramo(RichCommandLink clinkTramo) {
        this.clinkTramo = clinkTramo;
    }

    public RichCommandLink getClinkTramo() {
        return clinkTramo;
    }
