...
public class VigenciaPermisosVertimientoBean extends StandarBean{
    ...
    public VigenciaPermisosVertimientoBean(){
            ...
            try{
                ...
                if(usuarioConectado==null){
                        datos= uad.getEstadosVertimientos(null);
                }else{   
                    ...
                    if (pp.getCodigo()==ConstantesCalidad.PERFIL_CONSULTA){
                            ...
                            datos= uad.getEstadosVertimientos(usuarioConectado.getUsuario().
