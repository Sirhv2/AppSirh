...
public class MuestrasPorTipoIdeamBean  extends StandarBean{
    ...
    public MuestrasPorTipoIdeamBean()  {
    }
...
*/
        try{
            ...
            datos = cald.getCantidadTipoMuestrasIdeam();
/*        
            if(usuarioConectado==null){
                datos = cald.getCantidadTipoMuestrasm();
            }else{   
