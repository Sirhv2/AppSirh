...
public class InvestigacionGestionBean extends StandarBean{
    private RichPanelStretchLayout psl1;
    private UIGraph pg1;

    private String[] columnLabels = { "Investigacion de Especialistas" };
    private String[] seriesLabels;
    private Object[][] data2;
    private GraphDataModel graphData;

    public InvestigacionGestionBean(){
            String datos[][] = null;
            ...
            try{
                ...
                if(usuarioConectado==null){
                    datos= uad.getInvestigacionEspecialistas(null);
                    } else {   
                        ...
                        if (pp.getCodigo()==ConstantesCalidad.PERFIL_CONSULTA){
                            ...
                            datos= uad.getInvestigacionEspecialistas(usuarioConectado.getUsuario().
