...
public class MuestrasPorTipoSubtBean  extends StandarBean{
    ...
    public MuestrasPorTipoSubtBean() {
    ...
    public void graficarTodo(){
        ...
        CalidadDelegate cald = CalidadDelegate.getInstance();
            ...
            if(usuarioConectado==null){
                datos = cald.getCantidadTipoMuestrasSubt(null);
                        ...
                        if (pp.getCodigo()==ConstantesCalidad.PERFIL_CONSULTA){
                            datos = cald.getCantidadTipoMuestrasSubt(null);
                                ...
                                datos= cald.getCantidadTipoMuestrasSubt(usuarioConectado.getUsuario().
