...
public class CaptacionTipoFuenteBean extends StandarBean{
    private RichPanelStretchLayout panelStretchLayout1;
    private UIGraph pieGraph1;
    private String[] columnLabels = { "Tipo fuentes" };
    private String[] seriesLabels;
    private Object[][] data2;
    private GraphDataModel graphData;
    
    public CaptacionTipoFuenteBean(){
            ...
            try{
                ...
                if(usuarioConectado==null){
                        datos= uad.getCaptacionesTipoFuente(null);
                }else{   
                    ...
                    if (pp.getCodigo()==ConstantesCalidad.PERFIL_CONSULTA){
                            ...
                            datos= uad.getCaptacionesTipoFuente(usuarioConectado.getUsuario().
