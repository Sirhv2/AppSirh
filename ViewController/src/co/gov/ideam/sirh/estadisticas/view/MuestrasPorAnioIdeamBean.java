...
public class MuestrasPorAnioIdeamBean extends StandarBean{
    ...
    public MuestrasPorAnioIdeamBean() {
    }
...
*/
      try{       
            ...
            datos = cald.getCantidadMuestrasAnioIdeam();
/*          
            if(usuarioConectado==null){
                datos = cald.getCantidadMuestrasAnio(null);
                    ...
                    if (pp.getCodigo()==ConstantesCalidad.PERFIL_CONSULTA){
                        ...
                        datos= cald.getCantidadMuestrasAnio(usuarioConectado.getUsuario().
