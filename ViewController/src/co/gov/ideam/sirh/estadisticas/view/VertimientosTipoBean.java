...
public class VertimientosTipoBean extends StandarBean{
    ...
    public VertimientosTipoBean() {
        ...
        try{
            ...
            if(usuarioConectado==null){
                datos= uad.getVertimientosTipo(null);
                } else {   
             ...
             datos= uad.getVertimientosTipo(usuarioConectado.getUsuario().
