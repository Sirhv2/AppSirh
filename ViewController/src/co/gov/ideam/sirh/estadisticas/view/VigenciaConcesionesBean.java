...
public class VigenciaConcesionesBean extends StandarBean{
    ...
    public VigenciaConcesionesBean(){
            ...
            try{
                ...
                if(usuarioConectado==null){
                        datos= uad.getEstadosConcesiones(null);
                }else{   
                    ...
                    if (pp.getCodigo()==ConstantesCalidad.PERFIL_CONSULTA){
                            ...
                            datos= uad.getEstadosConcesiones(usuarioConectado.getUsuario().
