...
public class CaudalesVertidosBean extends StandarBean{
    ...
    try{
        ...
        if(usuarioConectado==null){
         accionLink1= "dashBoardCaudalesVert";
        }else{   
                ...
                if (pp.getCodigo()==ConstantesCalidad.PERFIL_CONSULTA){
                       ...
                       accionLink1= "dashBoardCaudalesAutoridadVert";
                     }
             } 
    }catch(Exception e){
