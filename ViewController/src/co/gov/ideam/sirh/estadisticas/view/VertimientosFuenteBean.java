...
public class VertimientosFuenteBean extends StandarBean{
    private RichPanelStretchLayout panelStretchLayout1;
    private UIGraph barGraph1;
    private GraphDataModel graphData;
    private String[] columnLabels = { "Vertimientos" };
    private String[] seriesLabels;
    private Object[][] data2;

    public VertimientosFuenteBean() {
        ...
        try{
            ...
            if(usuarioConectado==null){
                datos= uad.getVertimientosFuentes(null);
                } else {   
                    ...
                    if (pp.getCodigo()==ConstantesCalidad.PERFIL_CONSULTA){
                        datos= uad.getVertimientosFuentes(null);
                         ...
                         datos= uad.getVertimientosFuentes(usuarioConectado.getUsuario().
            ...
            for(int i=0; i<datos[0].length; i++){
                if(datos[1][i]!=null){
                    ...
                    //System.out.println("++++++++++++++Rio:"+seriesLabels[i]);
                    data2[0][i] = new Integer(datos[1][i]);  
                    //System.out.println("++++++++++++++Cantidad:"+data2[0][i]);
                }
            }
            initGraphDataModel();
