...
public class NaturalezaUsuariosSubtBean extends StandarBean {
  ...
  public NaturalezaUsuariosSubtBean() {
    ...
    try {
      ...
      if (usuarioConectado == null) {
        datos = uad.getNaturalezaUsuariosSubt(null);
      } else {
        ...
        if (pp.getCodigo() == ConstantesCalidad.PERFIL_CONSULTA) {
          ...
          datos =
              uad.getNaturalezaUsuariosSubt(usuarioConectado.getUsuario().getAutoridadAmbiental().getId().longValue());
        }
      }
  ...
  public void pg_naturaleza_clickListener(ClickEvent clickEvent) {
    ...
    if (handle instanceof DataComponentHandle) {
      ...
      String params[] = { "los usuarios", naturalezaSeleccionada };
