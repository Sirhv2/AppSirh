...
public class UbicacionUsuarios extends StandarBean{
    ...
    public UbicacionUsuarios(){
            ...
            try{
                ...
                if(usuarioConectado==null){
                    datos= uad.getUbicacionUsuarios(null);
                    } else {   
                 ...
                 datos= uad.getUbicacionUsuarios(usuarioConectado.getUsuario().
        ...
        if (handle instanceof DataComponentHandle){
            ...
            if(seriesInfo != null){                 
                for(Attributes attrs: seriesInfo){
                    ubicacionSeleccionada = attrs.getValue(Attributes.ID_VALUE).toString();
                }
            }            
            String params[] = {"los predios",
                               ubicacionSeleccionada};
