...
@Entity
@NamedQueries( { 
        @NamedQuery(name = "ConcesionSinc.findAll",query = "select o from ConcesionSinc o where o.codigoPredio = :codigoPredio and o.no_valida is null order by o.numeroExpediente"),//Pilar
        @NamedQuery(name = "ConcesionSinc.find", query = "select o from ConcesionSinc o where o.codigo = :codigo"),
        @NamedQuery(name = "ConcesionSinc.findByPredioResolucion", query = "select o from ConcesionSinc o where o.codigoPredio = :codigoPredio AND upper(o.resolucionCaudal) = :resolucionCaudal"),
        @NamedQuery(name = "ConcesionSinc.findByPredioSinConc", query = "select o from ConcesionSinc o where o.codigoPredio = :codigoPredio and no_valida is not null")//Pilar
        } )
@Table(name = "rurt_concesiones_sinc")
public class ConcesionSinc implements Serializable {
