...
public class UsuariosAguaPermisosNaturalConverter extends ModelConverter{
    public UsuariosAguaPermisosNaturalConverter() {
        super();
    }
    ...
    private PermisoVertimiento getPermisoVertimiento(PermisoVertimiento permiso)throws IdeamException{
        ...
        System.out.println("===================================================27ENE="+this.row.getCellValue("Resolucion Permiso Vertimiento").toString());
        permiso.setResolucionPermisoVertimiento( this.row.getCellValue("Resolucion Permiso Vertimiento").toString() );
        System.out.println("===================================================="+permiso.getResolucionPermisoVertimiento());
    ...
    private PuntoVertimientoTratamiento getPretratamiento(PuntoVertimiento vertimiento)throws IdeamException{
        ...
        if(nombreTratamiento==null || nombreTratamiento.trim().equalsIgnoreCase("")){
            ...
            if(tipoTratamiento == null){
                return null;
                //throw new IdeamException("No es posible encontrar un Pretratamiento con nombre " + nombreTratamiento );    
            }else{
    ...
    private PuntoVertimientoTratamiento getPrimario(PuntoVertimiento vertimiento)throws IdeamException{
        ...
        if(nombreTratamiento==null || nombreTratamiento.trim().equalsIgnoreCase("")){
            ...
            if(tipoTratamiento == null){
                return null;
                //throw new IdeamException("No es posible encontrar un tratamiento Primario con nombre " + nombreTratamiento );    
            }else{
                tratamiento.setIdTratamiento(tipoTratamiento.getCodigo());
    ...
    private PuntoVertimientoTratamiento getSecundario(PuntoVertimiento vertimiento)throws IdeamException{
        ...
        if(nombreTratamiento==null || nombreTratamiento.trim().equalsIgnoreCase("")){
            ...
            if(tipoTratamiento == null){
                return null;
                //throw new IdeamException("No es posible encontrar un tratamiento Secundario con nombre " +nombreTratamiento );    
            }else{
                tratamiento.setIdTratamiento(tipoTratamiento.getCodigo());
    ...
    private PuntoVertimientoTratamiento getTerciario(PuntoVertimiento vertimiento)throws IdeamException{
        ...
        if(nombreTratamiento==null || nombreTratamiento.trim().equalsIgnoreCase("")){
            ...
            if(tipoTratamiento == null){
                return null;
                //throw new IdeamException("No es posible encontrar un tratamiento Terciario con nombre " + nombreTratamiento );    
            }else{
                tratamiento.setIdTratamiento(tipoTratamiento.getCodigo());
    ...
    private PuntoVertimientoTratamiento getOtro(PuntoVertimiento vertimiento)throws IdeamException{
        ...
        if(nombreTratamiento==null || nombreTratamiento.trim().equalsIgnoreCase("")){
            ...
            if(tipoTratamiento == null){
                return null;
                //throw new IdeamException("No es posible encontrar un tratamiento de Otro tipo con nombre " + nombreTratamiento );    
            }else{
                tratamiento.setIdTratamiento(tipoTratamiento.getCodigo());
