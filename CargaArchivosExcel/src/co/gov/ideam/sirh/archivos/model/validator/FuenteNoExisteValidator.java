...
public class FuenteNoExisteValidator implements CompositeValidatorInterface, RequiresAutoridadValidatorInterface, Serializable {
    ...
    public FuenteNoExisteValidator() {
        super();
    }
    
    public FuenteNoExisteValidator(String columnaPadre, Long categoria) {
        super();
    ...
    public boolean valid(Object value) {
        if(this.campos !=null && columnaPadre!=null){
            ...
            System.out.println("Lista validator nombreLista: "+nombrePadre);
            if( nombrePadre != null && nombrePadre.length()>0){
                ...
                try{
                    ...
                    System.out.println("Validando desde composite " + tipo.getValor() + " " + tipo.getCodigo());
                    
                    System.out.println("Validando Fuente----------------------------- " + value.toString() + " " + tipo.getCodigo());

                    FnttFuente existe =  
                        fuentesService.getFuente(value.toString().trim(), 
    ...
    private FuentesEJB getFuentesService()throws IdeamException{
        try {
            ...
            throw new IdeamException("FuenteNoExisteValidator Imposible ubicar el EJB de Fuentes " + 
                                     e.getMessage());
        }        
    }   
