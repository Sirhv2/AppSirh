 ...
 */
@Entity
@Table(name = "CMAT_PERSONA_NATURAL_CA_V2")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "CmatPersonaNaturalCaV2.findAllPerNatCaV2", query = "SELECT c FROM CmatPersonaNaturalCaV2 c"),
    @NamedQuery(name = "CmatPersonaNaturalCaV2.findByCodigoRechazoPerNatCaV2", query = "SELECT c FROM CmatPersonaNaturalCaV2 c WHERE c.codigoRechazo = :codigoRechazo"),
    @NamedQuery(name = "CmatPersonaNaturalCaV2.findByIdRegistroPerNatCaV2", query = "SELECT c FROM CmatPersonaNaturalCaV2 c WHERE c.idRegistro = :idRegistro"),
    @NamedQuery(name = "CmatFuniasConstruccionV2.findByIdControlCarguePerNatCaV2", query = "SELECT c FROM CmatFuniasConstruccionV2 c WHERE c.idControlCargue = :idControlCargue")})
public class CmatPersonaNaturalCaV2 implements Serializable {
    ...
    public CmatPersonaNaturalCaV2() {
    }

    public CmatPersonaNaturalCaV2(double idRegistro) {
    ...
    public String toString() {
        return "Entidades.CmatPersonaNaturalCaV2[ idRegistro=" + idRegistro + " ]";
    }
