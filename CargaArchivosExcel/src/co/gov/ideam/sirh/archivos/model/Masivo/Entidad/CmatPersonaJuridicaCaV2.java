 ...
 */
@Entity
@Table(name = "CMAT_PERSONA_JURIDICA_CA_V2")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "CmatPersonaJuridicaCaV2.findAllPerJurCaV2", query = "SELECT c FROM CmatPersonaJuridicaCaV2 c"),
    @NamedQuery(name = "CmatPersonaJuridicaCaV2.findByCodigoRechazoPerJurCaV2", query = "SELECT c FROM CmatPersonaJuridicaCaV2 c WHERE c.codigoRechazo = :codigoRechazo"),
    @NamedQuery(name = "CmatPersonaJuridicaCaV2.findByIdRegistroPerJurCaV2", query = "SELECT c FROM CmatPersonaJuridicaCaV2 c WHERE c.idRegistro = :idRegistro"),
    @NamedQuery(name = "CmatFuniasConstruccionV2.findByIdControlCarguePerJurCaV2", query = "SELECT c FROM CmatFuniasConstruccionV2 c WHERE c.idControlCargue = :idControlCargue")})
public class CmatPersonaJuridicaCaV2 implements Serializable {
    ...
    @Column(name = "NOMBRE_PUNTO_CAP")
    private String nombrePuntoCap;
    @Column(name = "NOMBRE_PUNTO_AGUAS_ARRIBA_CAP")
    private String nombrePuntoAguasArribaCap;
    @Column(name = "NOMBRE_PUNTO_AGUAS_ABAJO_CAP")
    private String nombrePuntoAguasAbajoCap;
    @JoinColumn(name = "ID_CONTROL_CARGUE", referencedColumnName = "ID")
    @ManyToOne
    private CmatControlCargueV2 idControlCargue;

    public CmatPersonaJuridicaCaV2() {
    }

    public CmatPersonaJuridicaCaV2(double idRegistro) {
    ...
    public String getNombrePuntoCap() {
        return nombrePuntoCap;
    }

    public void setNombrePuntoCap(String nombrePuntoCap) {
        this.nombrePuntoCap = nombrePuntoCap;
    }

    public String getNombrePuntoAguasArribaCap() {
        return nombrePuntoAguasArribaCap;
    }

    public void setNombrePuntoAguasArribaCap(String nombrePuntoAguasArribaCap) {
        this.nombrePuntoAguasArribaCap = nombrePuntoAguasArribaCap;
    }

    public String getNombrePuntoAguasAbajoCap() {
        return nombrePuntoAguasAbajoCap;
    }

    public void setNombrePuntoAguasAbajoCap(String nombrePuntoAguasAbajoCap) {
        this.nombrePuntoAguasAbajoCap = nombrePuntoAguasAbajoCap;
    }
    ...
    public String toString() {
        return "Entidades.CmatPersonaJuridicaCaV2[ idRegistro=" + idRegistro + " ]";
    }
