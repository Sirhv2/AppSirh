...
public class UsuariosAguaCaptacionesServiciosValidator extends AbstractValidator{
    public UsuariosAguaCaptacionesServiciosValidator() {
       ...
       // numeroDocReresentante.addValidator( new LongValidator() );             
        ...
        this.columnas.add( new ColumnTO("Nombre sitio",17) );
        ...
        sistemaReferencia.addValidator( new ListasOpcionalValidator(6L, "Sistema de Referencia") );
