...
public class UsuariosAguaPermisosJuridicaValidator extends AbstractValidator{
    
    public UsuariosAguaPermisosJuridicaValidator() {
        ...
        ColumnTO tcpVertimiento = new ColumnTO("Tipo Centro Poblado",21);
        ...
        ColumnTO tiempoDescarga = new ColumnTO("Tiempo Descarga", 61);
        ...
        ColumnTO fechaFinPsmv = new ColumnTO("Fecha final PSMV", 81);
