...
@Entity
@NamedQueries({
  @NamedQuery(name = "PermisoVertimiento.findAll", query = "select o from PermisoVertimiento o where o.codigoPredio = :codigoPredio"),
  @NamedQuery(name = "PermisoVertimiento.find", query = "select o from PermisoVertimiento o where o.codigo = :codigo"),
  @NamedQuery(name = "PermisoVertimiento.findByExpediente", query = "select o from PermisoVertimiento o where upper(o.numeroExpediente) = :numeroExpediente")
})
@Table(name = "rurt_permisos_vertimientos")
public class PermisoVertimiento implements Serializable{
    @GenericGenerator(name = "permisos_generator", 
    ...
    @Id
    //@GeneratedValue(generator = "permisos_generator")        
