...
public class IdeamSirhGeneratorCalidad extends SequenceGenerator implements Configurable{
    private String autoridadAmbientalId;
    private String codigo;
    
    public IdeamSirhGeneratorCalidad() {
        super();
    }
    /**
     *
    ...
    public void configure(Type type, Properties params, Dialect d) throws MappingException {
        ...
        /*System.out.println("Configurando.... " + type.getClass().getName());
    ...
    public synchronized Serializable generate(SessionImplementor sessionImplementor,
        ...
        return ((Long)codigoAutoridadAmbiental).longValue() * 100000000 + ((Number)id).longValue();
        /*
        ...
        Long id = null;
        try {
            ps = connection.prepareStatement("select  nextval('seq_usuario_agua'::regclass)");
            rs = ps.executeQuery();
            if (rs.next()) {
