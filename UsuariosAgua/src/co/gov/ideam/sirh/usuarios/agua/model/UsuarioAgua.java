...
@Entity
@NamedQueries({ 
  @NamedQuery(name = "UsurioAgua.findAllUsers", query = "select o from UsuarioAgua o"),
  @NamedQuery(name = "UsurioAgua.findAll", query = "select o from UsuarioAgua o where o.codigoAutoridad = :codigoAutoridad"),
  @NamedQuery(name = "UsurioAgua.find", query = "select o from UsuarioAgua o where o.codigo = :codigo"),
  @NamedQuery(name = "UsurioAgua.findByDocumento", query = "select o from UsuarioAgua o where o.codigoTipoDocumento = :codigoTipoDocumento and o.numeroDocumento = :numeroDocumento and o.codigoAutoridad = :codigoAutoridad")
})
@Table(name = "rurt_usuarios_agua")
public class UsuarioAgua implements Serializable{      
