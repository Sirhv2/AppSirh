...
@Entity
@NamedQueries({
  @NamedQuery(name = "Predio.findAll", query = "select o from Predio o where o.codigoUsuario = :codigoUsuario order by o.nombre"),
  @NamedQuery(name = "Predio.find", query = "select o from Predio o where o.codigo = :codigo"),
  @NamedQuery(name = "Predio.findByCedula", query = "select o from Predio o where upper(o.cedulaCatastral) = :cedulaCatastral"),
  @NamedQuery(name = "Predio.findByCedulaUsuarioAutoridad", query = "select o from Predio o where upper(o.cedulaCatastral) = :cedulaCatastral and codigoUsuario = :codigoUsuario and codigoAutoridad = :codigoAutoridad")
 
})
@Table(name = "rurt_predios")
public class Predio implements Serializable{
    @GenericGenerator(name = "predios_generator", 
