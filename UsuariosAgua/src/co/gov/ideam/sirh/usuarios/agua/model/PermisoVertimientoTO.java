...
@Entity
@NamedQueries({
   @NamedQuery(name = "PermisoVertimientoTO.findAll", query = "select o from PermisoVertimientoTO o"),
   @NamedQuery(name = "PermisoVertimientoTO.findByExpediente", query = "select o from PermisoVertimientoTO o where upper(o.numeroExpediente) like :numeroExpediente"),
   @NamedQuery(name = "PermisoVertimientoTO.findByExpedienteAutoridad", query = "select o from PermisoVertimientoTO o where upper(o.numeroExpediente) like :numeroExpediente and o.codigoAutoridad =:codigoAutoridad"),
   @NamedQuery(name = "PermisoVertimientoTO.findByOneExpedienteAutoridad", query = "select o from PermisoVertimientoTO o where upper(o.numeroExpediente) = :numeroExpediente and o.codigoAutoridad =:codigoAutoridad"),
   @NamedQuery(name = "PermisoVertimientoTO.findByAutoridad", query = "select o from PermisoVertimientoTO o where o.codigoAutoridad =:codigoAutoridad"),
   @NamedQuery(name = "PermisoVertimientoTO.findByExpedienteResolucionPredioAutoridad", 
               query = "select o from PermisoVertimientoTO o where upper(o.numeroExpediente) like :numeroExpediente and upper(o.resolucionPermisoVertimiento) = :resolucionPermisoVertimiento and o.codigoPredio = :codigoPredio and o.codigoAutoridad =:codigoAutoridad")
 })
@Table(name = "rurv_permisos")
public class PermisoVertimientoTO implements Serializable{
