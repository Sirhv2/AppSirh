...
public class PorhTramosUsosObjetivo implements Serializable {
   ...
   // @GeneratedValue(generator = "porh_generator")        
    ...
    @JoinColumn(name = "objetivo_ecologico", referencedColumnName = "id")
    @ManyToOne(optional = false)
    private Lista objetivoEcologico; 
    ...
    public PorhTramosUsosObjetivo(Long id, Lista parametro,
                                  ...
                                  Double valor,Lista objetivoEcologico) {
        this.id = id;
  ...
  public void setObjetivoEcologico(Lista objetivoEcologico) {
    this.objetivoEcologico = objetivoEcologico;
  }

  public Lista getObjetivoEcologico() {
