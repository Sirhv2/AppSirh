...
@Entity
@NamedQueries({
  @NamedQuery(name = "ActOrganizacionesPG.findAllByAutoridad", query = "select o from ActOrganizaciones o where o.codigoAutoridad = :codigoAutoridad"),
  @NamedQuery(name = "ActOrganizacionesPG.find", query = "select o from ActOrganizaciones o where o.id = :id")
})
@Table(name = "ACT_ORGANIZACIONES")
public class ActOrganizacionePG implements Serializable {
    ...
    public ActOrganizacionePG() {
    }

    public ActOrganizacionePG(Long depto, String direccion, Long id,
