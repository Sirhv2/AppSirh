...
package co.gov.ideam.sirh.remoto.sender.modelo.types;
 ...
 * generated in the co.gov.ideam.sirh.remoto.sender.modelo.types package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: co.gov.ideam.sirh.remoto.sender.modelo.types
     * 
     */
